    ...
    <div className={`scalp-simulator ${className}`}>
      <div className="sim-header">
        ...
        <div className="sim-mode-toggle">
          <button className={mode === 'single' ? 'active' : ''} onClick={() => setMode('single')}>Single Trade</button>
          <button className={mode === 'batch' ? 'active' : ''} onClick={() => setMode('batch')}>100-Trade Batch</button>
        </div>
      </div>
